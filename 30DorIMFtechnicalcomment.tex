...
The analysis above used the same assumptions as \citet{Schneider:2018}.  Below, we consider the impact of three additional  assumptions: the stellar lifetime fit; the choice of the completeness limit; and the model for the star formation history.
...
$\tau_{MS}$ of non-rotating massive stars as modelled by \citet{Brott:2011} and \citet{Kohler:2015}:
%
\begin{multline}
...
In our models, following \citet{Schneider:2018}, we increase the ``observable''
...
The combination of these factors makes it very challenging to infer the precise shape of the IMF even when a data set as good as that obtained by \citet{Schneider:2018} is available.
