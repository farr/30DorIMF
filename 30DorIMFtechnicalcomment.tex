...
preferred set of assumptions yields an IMF power-law exponent of  $\alpharangethree$, consistent with the Salpeter value of $2.35$.  %We also discuss a number of modelling choices that can shift the exponent to steeper or shallower values.
\end{abstract}
